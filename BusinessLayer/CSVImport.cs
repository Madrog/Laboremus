...
namespace BusinessLayer
{
    public class CSVImport
    {
        ...
        private static object<T> ParseNow<T>(string row)
        {
        ...
        private static DateTime DateConversion(string dateString)
        {
        ...
        private static void BulkInsertSalesRecords(IEnumerable<T> salesList)
        {
            string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=CSVImport;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
